const Footer = () => {
  return (
    <div className="w-full py-10 px-20 flex font-pops items-start justify-center gap-80">
      ...
      <div className="flex gap-20">
        <div className="flex flex-col gap-3 text-white">
          <div className="mb-5 font-bold">Features</div>
        ...
        <div className="flex flex-col gap-3 text-white">
          <div className="mb-5 font-bold">Resources</div>
          <div className="text-sm hover:text-primaryCyan cursor-pointer">
            Blog
          </div>
          <div className="text-sm hover:text-primaryCyan cursor-pointer">
